...
>
	<article class="-mr-4 -ml-4 flex flex-col md:flex-row">
		<time
		...
		<div
			class="relative mt-8 ml-auto aspect-[1.625/1] w-full px-4 md:mt-0
				md:w-auto md:max-w-[41.67%] md:flex-[41.67%]"
		>
			<div
				class="banner-clip md:banner-clip-lg relative aspect-[1.625/1] h-auto
